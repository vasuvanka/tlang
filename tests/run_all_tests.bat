...
REM Test files
set TESTS=test_core_features.tl test_control_flow.tl test_data_structures.tl test_functions_errors.tl test_advanced_features.tl test_error_propagation.tl test_fixtures_example.tl
